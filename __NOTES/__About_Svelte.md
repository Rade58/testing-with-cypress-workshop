# YOU CAN PASS SERVER SIDE PROPS WITH SVELTE KIT; ALSO YOU CAN HAVE AN API
...
# THE REST OF THING IS SELF EVIDENT

THERE ARE SOME CONFUISION WITH SENDING "PATCH" AND "DELETE" NETWORK REQUEST; BECAUSE YOU NEED TO USE action ATRIBUTE TOGETHER WITH on:submit HENDLER, AND ALSO YOU NEED TO USE _method QUERY PARAMETER

CHECK THESE FILES

[component](src/routes/echo-chamber/posts/[id].svelte)

[api](src/routes/echo-chamber/api/[id].ts)
